    ...
    public function respond(Result $result): ApiResponse
    {
        return $result->match(
            onSuccess: fn () => new ApiResponse(
                    data: ['message' => __(key: 'identity.email.update.success')],
            ...
            onError: fn (\Throwable $e) => match (true) {
                ...
                $e instanceof EmailUnchangedException => new ApiResponse(
                    data: ['message' => $e->getMessage()],
                    status: Response::HTTP_CONFLICT
                ),
                $e instanceof UserNotFoundException => new ApiResponse(
                    data: ['message' => __(key: 'identity.email.update.failed')],
                    status: Response::HTTP_INTERNAL_SERVER_ERROR
                ),
                default => new ApiResponse(
                    data: ['message' => __(key: 'identity.email.update.unknown')],
                    status: Response::HTTP_INTERNAL_SERVER_ERROR
                ),
            }
        );
